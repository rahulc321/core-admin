...
else
{
    ...
    $query=mysqli_query($con, "update tblvit set Image='$itempic' where ID='$cid'");
    if ($query) {
    $msg="Product Item image has been updated.";
  }
  else
    {
...
<body>
 ...
 <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select * from tblvit where ID='$cid'");
$cnt=1;
