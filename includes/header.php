 ...
 <p style="font-size: 20px;padding-top:1%" ><strong>Cleaning</strong></p>
...
{
            ?>
            <a class="dropdown-item" href="viewproductorder.php?orderid=<?php echo $result['Ordernumber'];?>">   <i class="fa fa-envelope fa-fw"></i>  #<?php echo $result['Ordernumber'];?> Order Received from <?php echo $result['FirstName'];?></a>
<?php }} else {?>
