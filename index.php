...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from users where  email='$adminuser' && Password='$password'  and type=1");
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="font-bold">Delhi Gram Panchayat Sangh  | Admin Login</h2>
