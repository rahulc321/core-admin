...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update users set firstName='$fname', lastName='$lname', phone='".$_POST['mobilenumber']."' where ID='$sid'");
...
<body>
    ...
    echo $msg;
                      ...
                      <?php
$sid=$_GET['userid'];
$ret=mysqli_query($con,"select * from users where id='$sid'");
$cnt=1;
                                    ...
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">First Name:</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Mobile Number:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="mobilenumber"   value="<?php  echo $row['phone'];?>"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Registration Date:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="price" readonly="true" value="<?php  echo $row['cteated_at'];?>"></div>
                                            </div>
