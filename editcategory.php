...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update category set catname ='$category',status ='".$_POST['status']."' where id=$eid");
    if ($query) {
...
?>
                                    <fieldset>
                                    <h2>Cleaner Category</h2>
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                
                                                <input id="categoryname" name="categoryname" type="text" class="form-control required" required="true" value="<?php  echo $row['catname'];?>">
                                            </div>
                                            <div class="form-group">
